...
export default function Search() {
  ...
  const [requiredSkills, setRequiredSkills] = useState('Strategy, Data Analysis, ESG')
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">Min Diversity %</label>
            <input 
              type="number" 
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              placeholder="30"
      ...
      <div className="mt-8">
          ...
          <div className="flex items-center justify-center py-12">
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex flex-wrap gap-2 mt-2 justify-center">
                ...
                <span className="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-medium rounded-full">KPIs</span>
                <span className="px-3 py-1 bg-purple-50 text-purple-700 text-xs font-medium rounded-full">Projects</span>
                <span className="px-3 py-1 bg-green-50 text-green-700 text-xs font-medium rounded-full">360 Feedback</span>
                <span className="px-3 py-1 bg-amber-50 text-amber-700 text-xs font-medium rounded-full">Interests</span>
                <span className="px-3 py-1 bg-gray-50 text-gray-700 text-xs font-medium rounded-full">Availability</span>
              </div>
            </div>
          </div>
        )}
        {!loading && results.length === 0 && (
          <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">Ready to Generate Shortlist</h3>
            <p className="text-gray-600 mb-4">Fill in the mission parameters above and click "Generate Top 30% Shortlist"</p>
            ...
            <div className="bg-green-50 border border-green-200 p-4 rounded-lg mb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Shortlist Generated</h4>
                    <p className="text-sm text-gray-600">{results.length} high-readiness candidates identified</p>
                  </div>
                </div>
                <a 
                  href="/team" 
